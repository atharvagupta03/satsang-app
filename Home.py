...
if not st.session_state.authenticated:
    ...
    if submitted:
        if username in ADMINS and ADMINS[username] == password:
            ...
            st.error("Login is restricted to some people.... also you have entered either Invalid username or password..")

# --- If logged in, show dashboard ---
else:
    st.success(f"Welcome, {st.session_state.username} ✅")
    st.write("Please, use the sidebar to navigate to different verticals.")
